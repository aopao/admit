                                                ...
                                                @foreach($plan_list as $plan)
                                                    <tr align="center">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{route('admin.student.edit',['student_id'=>$student_info['id'],'plan_model_id'=>$plan['id']])}}" class="btn btn-outline btn-primary btn-xs"><i class="icon wb-pencil" aria-hidden="true"></i></a>
                                                            <a href="{{route('admin.student.destroy',['student_id'=>$student_info['id'],'plan_model_id'=>$plan['id']])}}" class="btn btn-outline btn-warning btn-xs"><i class="icon wb-trash" aria-hidden="true"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @endif
