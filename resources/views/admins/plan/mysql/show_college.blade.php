                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="form-group col-md-5">
                                    <label class="form-control-label" for="inputEstimateScore">@lang('student.estimate_score')&nbsp;&nbsp;&nbsp;[<span style="color: orangered">@lang('student.estimate_score_tips')</span>]：</label>
