...
@section('content')
    ...
    <div class="page-content">
        <form action="{{ route('admin.plan.searchKnowScore',['student_id'=>$student_info['id'],'plan_model_id'=>$plan_detail['id']]) }}" method="get">
            <div class="panel">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="form-group col-md-5">
                                    <label class="form-control-label" for="inputEstimateScore">@lang('student.exam_score')&nbsp;&nbsp;&nbsp;&nbsp;[<span style="color: red">@lang('student.exam_score_tips')</span>]：</label>
                                    <div class="form-inline">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="inputEstimateScore" name="exam_score" value="" placeholder="@lang('student.exam_score')" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
